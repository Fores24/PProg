 ...
 *Description:Funcion que se encarga de crear el juego
 *Input: Game y el nombre del jugadors
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que crear un juego desde un fichero
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de liberar la memoria de game
*Input: Game
*Output: OK si todo funciona bien y Error si hay algun fallo.
********************************************************************/
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de añadir espacios
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de leer el id
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se encarga de leer el space y devolverlo
*Input: Game y el id
*Output: space
********************************************************************/
...
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de establecer la localizaciondel objecto
*Input: Game id y id del objeto
*Output: OK si todo funciona bien y Error si hay algun fallo.
********************************************************************/
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de devolver la localizacion del jugadors+
*Input: Game y el nombre del fichero donde esta el tablero
*Output: Id
********************************************************************/
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de devolver el id del objecto
*Input: Game y id
*Output: Id
********************************************************************/
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de actualizar el juego
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de leer los comandos
*Input: Game
*Output: devuelve el ultimo comando
********************************************************************/
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de escribir los datos
*Input: Game y el nombre del fichero donde esta el tablero
...
*Description: Funcion que se enccarga de leer los espacios y cargarlos
*Input: Game y el nombre del fichero donde esta el tablero
*Output: False si no ha terminado.
********************************************************************/
...
*Date:
*Autores: Saul Almazan y Alvaro Becerra Jiminez
*Description: Funcion que se enccarga de cargar los espacios
*Input: Game y el nombre del fichero donde esta el tablero
*Output: OK si todo funciona bien y Error si hay algun fallo.
********************************************************************/
